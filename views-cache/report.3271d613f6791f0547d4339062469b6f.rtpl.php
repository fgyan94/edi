		...
		<div id="delfor-data">
			...
			<div id="item">
				...
				<tr>
					...
					<td class="cell"><?php echo htmlspecialchars( $value1->getQtyUE(), ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
					<td class="header">Data Última Entrega:</td>
					<td class="cell"><?php echo htmlspecialchars( $value1->getDataUE(), ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
				</tr>
				</table>
					...
					<tbody>
						...
						<tr>
							...
							<?php if( $delfor->getStrategy() === 0 ){ ?>
								...
								<td><?php echo htmlspecialchars( $delfor->getPlanta(), ENT_COMPAT, 'UTF-8', FALSE ); ?><?php echo htmlspecialchars( $value1->getPartNumber(), ENT_COMPAT, 'UTF-8', FALSE ); ?><?php echo htmlspecialchars( $value1->getLineItemValues()["DATE_TIME"]["$counter2"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
							<?php } ?>
						</tr>
						<?php } ?>
					</tbody>

...
class Tpl {
	 ...
	 * @param bool $toString:
	 *        	if the method should return a string
	 *        	or echo the output
	 *        	
	 ...
	 *
	 * @param
	 *        	string, array $setting: name of the setting to configure
	 *        	or associative array type 'setting' => 'value'
	 * @param mixed $value:
	 *        	value of the setting to configure
	 ...
	 *        	nombre del tag
	 * @param regexp $parse
	 *        	regular expression to parse the tag
	 * @param
	 *        	anonymous function $function: action to do when the tag is parsed
	 */
	 ...
	 * @param string $name
	 *        	name can be used to distinguish plugins of same class.
	 */
	 ...
	 *
	 * @param string $string:
	 *        	RainTpl template string to compile
	 *        	
	 * @return string: full filepath that php must use to include
	 */

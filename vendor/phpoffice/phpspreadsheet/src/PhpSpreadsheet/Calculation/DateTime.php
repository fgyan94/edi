...
class DateTime {
	...
	public static function getDateValue($dateValue) {
		if (! is_numeric ( $dateValue )) {
			if ((is_string ( $dateValue )) && (Functions::getCompatibilityMode () == Functions::COMPATIBILITY_GNUMERIC)) {
	 ...
	 * @category Date/Time Functions
	 *          
	 * @param \DateTimeImmutable|float|int|string $endDate
	 *        	Excel date serial value (float),
	 *        	PHP date timestamp (integer), PHP DateTime object, or a standard date string
	 * @param \DateTimeImmutable|float|int|string $startDate
	 *        	Excel date serial value (float),
	 *        	PHP date timestamp (integer), PHP DateTime object, or a standard date string
	 *        	

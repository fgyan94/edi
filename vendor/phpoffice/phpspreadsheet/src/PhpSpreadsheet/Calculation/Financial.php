...
class Financial {
	...
	private static function isValidFrequency($frequency) {
		...
		if ((Functions::getCompatibilityMode () == Functions::COMPATIBILITY_GNUMERIC) && (($frequency == 6) || ($frequency == 12))) {
			return true;
		}
	 ...
	 * @param
	 *        	array of float $values A series of cash flows that corresponds to a schedule of payments in dates.
	 *        	The first payment is optional and corresponds to a cost or payment that occurs at the beginning of the investment.
	 *        	If the first value is a cost or payment, it must be a negative value. All succeeding payments are discounted based on a 365-day year.
	 *        	The series of values must contain at least one positive value and one negative value.
	 * @param
	 *        	array of mixed $dates A schedule of payment dates that corresponds to the cash flow payments.

...
class LookupRef {
	 ...
	 * =COLUMN([cellAddress])
	 *
	 * @param null|array|string $cellAddress
	 ...
	 *
	 * @param null|string $cellAddress
	 *        	The reference from which you want to base the offset. Reference must refer to a cell or
	...
	public static function HLOOKUP($lookup_value, $lookup_array, $index_number, $not_exact_match = true) {
		...
		foreach ( $lookup_array [$firstColumn] as $rowKey => $rowData ) {
			...
			if (($bothNumeric && $rowData > $lookup_value) || ($bothNotNumeric && strtolower ( $rowData ) > strtolower ( $lookup_value ))) {
				break;
			}
			...
			if ($bothNumeric || $bothNotNumeric) {
				if ($not_exact_match) {
					...
					continue;
				} elseif (strtolower ( $rowData ) === strtolower ( $lookup_value ) && ($rowNumber === null || $rowKey < $rowNumber)) {
					$rowNumber = $rowKey;
				}
			}
		}

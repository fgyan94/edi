...
class Calculation {
	 ...
	 *        	Injected spreadsheet for working with a PhpSpreadsheet Spreadsheet object,
		...
		if ($this->debugLog->getWriteDebugLog ()) {
			...
			if (is_array ( $value )) {
				...
				foreach ( $value as $row ) {
					if (is_array ( $row )) {
						$returnMatrix [] = implode ( $pad, array_map ( [ 
								$this,
								'showValue'
						], $row ) );
						$rpad = '; ';

...
class Worksheet implements IComparable {
	 ...
	 *        	Flag indicating whether cell references in formulae should
	 *        	be updated to reflect the new sheet name.
	 *        	This should be left as the default true, unless you are
	 *        	certain that no formula cells on any worksheet contain
	 *        	references to this worksheet
	 * @param bool $validate
	 *        	False to skip validation of new title. WARNING: This should only be set
	 ...
	 *        	Flag indicating whether a new cell should be created if it doesn't
	 ...
	 *
	 * @param null|string $cell
	 *        	Position of the split
	 * @param null|string $topLeftCell
	 *        	default position of the right bottom pane
	 *        	
	 * @throws Exception
	 *
	 ...
	 *
	 * @param string $pValue
	 *        	Same rule as Title minus space not allowed (but, like Excel, change

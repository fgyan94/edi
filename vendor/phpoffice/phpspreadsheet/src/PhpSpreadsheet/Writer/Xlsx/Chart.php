...
class Chart extends WriterPart {
	 ...
	 * @param XMLWriter $objWriter
	 *        	XML Writer
	 * @param \PhpOffice\PhpSpreadsheet\Chart\Layout $chartLayout
	 *        	Chart layout
	 */
	...
	private function writeValueAxis($objWriter, $yAxisLabel, $groupType, $id1, $id2, $isMultiLevelSeries, Axis $xAxis, GridLines $majorGridlines, GridLines $minorGridlines) {
		...
		if ($majorGridlines->getLineColorProperty ( 'value' ) !== null) {
			...
			if ($majorGridlines->getLineStyleProperty ( [ 
					'arrow',
					'head',
					'type'
			] ) !== null) {
				$objWriter->startElement ( 'a:headEnd' );
				$objWriter->writeAttribute ( 'type', $majorGridlines->getLineStyleProperty ( [ 
						'arrow',
						'head',
						'type'
				] ) );
		...
		if ($majorGridlines->getShadowProperty ( 'presets' ) !== null) {
			...
			if ($majorGridlines->getShadowProperty ( [ 
					'size',
					'sx'
			] ) !== null) {
				$objWriter->writeAttribute ( 'sx', $majorGridlines->getShadowProperty ( [ 
						'size',
						'sx'
				] ) );
			}
			if ($majorGridlines->getShadowProperty ( [ 
				...
				$objWriter->writeAttribute ( 'sy', $majorGridlines->getShadowProperty ( [ 
						'size',
						'sy'
				] ) );
			}
			if ($majorGridlines->getShadowProperty ( [ 
				...
				$objWriter->writeAttribute ( 'kx', $majorGridlines->getShadowProperty ( [ 
						'size',
						'kx'
				] ) );
			}
			...
			$objWriter->writeAttribute ( 'val', $majorGridlines->getShadowProperty ( [ 
					'color',
					'value'
			] ) );
		...
		if ($minorGridlines->getObjectState ()) {
			...
			if ($minorGridlines->getLineColorProperty ( 'value' ) !== null) {
				...
				if ($minorGridlines->getLineStyleProperty ( [ 
						'arrow',
						'head',
						'type'
				] ) !== null) {
					$objWriter->startElement ( 'a:headEnd' );
					$objWriter->writeAttribute ( 'type', $minorGridlines->getLineStyleProperty ( [ 
							'arrow',
							'head',
							'type'
					] ) );
			...
			if ($minorGridlines->getShadowProperty ( 'presets' ) !== null) {
				...
				if ($minorGridlines->getShadowProperty ( [ 
						'size',
						'sx'
				] ) !== null) {
					$objWriter->writeAttribute ( 'sx', $minorGridlines->getShadowProperty ( [ 
							'size',
							'sx'
					] ) );
				}
				if ($minorGridlines->getShadowProperty ( [ 
					...
					$objWriter->writeAttribute ( 'sy', $minorGridlines->getShadowProperty ( [ 
							'size',
							'sy'
					] ) );
				}
				if ($minorGridlines->getShadowProperty ( [ 
					...
					$objWriter->writeAttribute ( 'kx', $minorGridlines->getShadowProperty ( [ 
							'size',
							'kx'
					] ) );
				}
				...
				$objWriter->writeAttribute ( 'val', $minorGridlines->getShadowProperty ( [ 
						'color',
						'value'
				] ) );
				$objWriter->startElement ( 'a:alpha' );
		...
		if ($xAxis->getLineStyleProperty ( [ 
				'arrow',
				'head',
				'type'
		] ) !== null) {
			$objWriter->startElement ( 'a:headEnd' );
			$objWriter->writeAttribute ( 'type', $xAxis->getLineStyleProperty ( [ 
					'arrow',
					'head',
					'type'
			] ) );
		...
		if ($xAxis->getGlowProperty ( 'size' ) !== null) {
			...
			$objWriter->writeAttribute ( 'val', $xAxis->getGlowProperty ( [ 
					'color',
					'value'
			] ) );
			$objWriter->startElement ( 'a:alpha' );
		...
		if ($xAxis->getShadowProperty ( 'presets' ) !== null) {
			...
			if ($xAxis->getShadowProperty ( [ 
					'size',
					'sx'
			] ) !== null) {
				$objWriter->writeAttribute ( 'sx', $xAxis->getShadowProperty ( [ 
						'size',
						'sx'
				] ) );
			}
			if ($xAxis->getShadowProperty ( [ 
				...
				$objWriter->writeAttribute ( 'sy', $xAxis->getShadowProperty ( [ 
						'size',
						'sy'
				] ) );
			}
			if ($xAxis->getShadowProperty ( [ 
				...
				$objWriter->writeAttribute ( 'kx', $xAxis->getShadowProperty ( [ 
						'size',
						'kx'
				] ) );
			}
			...
			$objWriter->writeAttribute ( 'val', $xAxis->getShadowProperty ( [ 
					'color',
					'value'
			] ) );
			$objWriter->startElement ( 'a:alpha' );
	 ...
	 *        	XML Writer
	 * @param
	 *        	bool &$catIsMultiLevelSeries Is category a multi-series category
	 * @param
	 *        	bool &$valIsMultiLevelSeries Is value set a multi-series set
	 * @param

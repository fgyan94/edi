...
class Spreadsheet {
	 ...
	 * scroll bar.
	 * TabRatio is assumed to be out of 1000 of the horizontal
	 * window width.
	 *
	 * @var int
	 */
	...
	public function addSheet(Worksheet $pSheet, $iSheetIndex = null) {
		...
		if ($iSheetIndex === null) {
			...
			array_splice ( $this->workSheetCollection, $iSheetIndex, 0, [ 
					$pSheet
			] );
	 ...
	 *
	 * @param bool $showHorizontalScroll
	 ...
	 * filtering optiomd in the user interface.
	 *
	 * @param bool $autoFilterDateGrouping
	 *        	true if workbook window is minimized
	 */

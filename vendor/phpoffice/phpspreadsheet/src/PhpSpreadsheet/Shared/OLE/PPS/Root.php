...
class Root extends PPS {
	...
	public function save($filename) {
		...
		$this->bigBlockSize = pow ( 2, (isset ( $this->bigBlockSize )) ? self::adjust2 ( $this->bigBlockSize ) : 9 );
		$this->smallBlockSize = pow ( 2, (isset ( $this->smallBlockSize )) ? self::adjust2 ( $this->smallBlockSize ) : 6 );
